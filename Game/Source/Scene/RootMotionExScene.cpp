...
// コンストラクタ
RootMotionExScene::RootMotionExScene()
{
...
// 更新処理
void RootMotionExScene::Update(float elapsedTime)
{
	// アニメーション切り替え操作
	if (animationLoop)
	{
...
// 描画処理
void RootMotionExScene::Render(float elapsedTime)
{
...
// GUI描画処理
void RootMotionExScene::DrawGUI()
{
